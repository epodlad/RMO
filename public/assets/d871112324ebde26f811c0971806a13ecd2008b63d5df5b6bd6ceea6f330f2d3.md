...
Run `python3 joint_geometry_bounds/audit.py` for the certificate and `python3 joint_geometry_bounds/report.py` for this report and vector figure. Prior scientific modules and output records remain unchanged.
