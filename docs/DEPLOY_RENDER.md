...
Before accepting a hosted release, check the public HTTPS address in a browser: page layout and all 38 analysis links; A63 input → Python → result → PDF; input/result JSON downloads; B01; supported import forms; scientific viewer frame changes; collapsed scientific evidence and lower history; two independent browser sessions. The 2017 media control deliberately presents attribution/source information in this derivative.
